...
def filter_data():
    ...
    if original_data_all:
        ...
        display_data(result)  # Show filtered data in GUI
        return result
...
# Create the GUI
def create_gui():
    global combo_A, combo_B, combo, tree
    ...
    tree = ttk.Treeview(root, columns=list(range(10)), show='headings')  # Adjust columns as needed
    ...
    # Set column headings
    for i in range(10):  # Adjust number of columns as needed
        tree.heading(i, text=f"Column {i+1}", anchor='center')
